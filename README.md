...
At REDACTED we provide the service of taking people from point A to point B.
...
You can ignore the Gitlab warning "REDACTED Challenge has exceeded its pipeline 
...
Cars are organized by available seats making use of a maps slice, again in terms of performance, being index `i` in charge of storing all cars with `i+1` available seats.
